...
struct CSRGraph {
	...
	// PRO: Property-driven Reordering
	void apply_property_driven_reordering(int &start_node_ref, bool do_vertex_reorder);
	...
	index_type *old_to_new_mapping; // For PRO: maps original node ID to new node ID
	bool device_graph;
	char file_name[256];
